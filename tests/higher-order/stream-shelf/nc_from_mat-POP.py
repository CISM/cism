...
uvel   = nc.createVariable('uvel',  'f',('time','level','y1','x1'))
vvel   = nc.createVariable('vvel',  'f',('time','level','y1','x1'))
#tempstag   = nc.createVariable('tempstag',  'f',('time','staglevel','y1','x1'))
#bwat     = nc.createVariable('bwat',     'f',('time','y1','x1'))

#Read the data:
d = loadmat('stream-shelf-pop.mat')    # to create input file for running w/ seacism

#Set the fields
#topg[0,:,:] = array(d['topg'],dtype='float32')
thk[0,:,:] = array(d['thck'],dtype='float32')
#usurf[0,:,:] = array(d['usrf_10km'],dtype='float32')
...
#kinbcmask[0,:,:] = array(d['kinbcmask_10km'],dtype='int8')
uvel[0,:,:,:] = array(d['uvel'],dtype='float32')
vvel[0,:,:,:] = array(d['vvel'],dtype='float32')
#tempstag[0,:,:,:] = array(d['tempstag'],dtype='float32')
