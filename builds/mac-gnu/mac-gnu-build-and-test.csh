...
# 1/16/2014 DMR -- This script has been modified to run in the builds/mac-gnu directory, using
# mac-gnu-cmake.
...
set CISM_VV_SCRIPT = $PLATFORM_NAME'_VV_new.bash'
...
make -j 4 >& $CMAKE_BUILD_OUT

if ( -e example-drivers/simple_glide/src/simple_glide ) then
 echo 'copy '$COMPILER_NAME' parallel executable to test directory'
